...
do
	...
	then
		# E1900 MENU OVERLAY
		dialog --backtitle "[E1900] EASYEPG SIMPLE XMLTV GRABBER > MAGENTA SETTINGS > DELETE INSTANCE" --title "WARNING" --yesno "Do you want to delete this service?" 5 50
		...
		if [ $response = 1 ]
		then
			dialog --backtitle "[E1910] EASYEPG SIMPLE XMLTV GRABBER > MAGENTA SETTINGS > DELETE INSTANCE" --title "INFO" --msgbox "Service not deleted!" 5 32
			echo "H" > /tmp/value
		...
		then
			dialog --backtitle "[E19X0] EASYEPG SIMPLE XMLTV GRABBER > MAGENTA SETTINGS > DELETE INSTANCE" --title "INFO" --msgbox "Service not deleted!" 5 30
			echo "H" > /tmp/value
		fi
