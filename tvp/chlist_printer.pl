...
foreach my $newattributes ( @newchannels_name2id ) {
...
foreach my $newattributes ( @newchannels_id2name ) {
...
foreach my $oldattributes ( @oldchannels_name2id ) {
...
foreach my $oldattributes ( @oldchannels_id2name ) {
