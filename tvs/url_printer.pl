...
foreach my $configname ( @configname ) {
	...
	if( defined $new_id ) {
		...
		# DAYS 1-8
			...
			print "curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date1' | sed '1i\\{\"Broadcastitems\":' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" > mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date2' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date3' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date4' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date5' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date6' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date7' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date8' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id\n" ;			 

		# DAYS 1-9
		} elsif( $day_setting == 9 ) {
			print "curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date1' | sed '1i\\{\"Broadcastitems\":' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" > mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date2' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date3' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date4' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date5' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date6' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date7' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date8' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date9' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id\n" ;			 
	
		# DAYS 1-10
		} elsif( $day_setting == 10 ) {
			print "curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date1' | sed '1i\\{\"Broadcastitems\":' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" > mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date2' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date3' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date4' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date5' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date6' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date7' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date8' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date9' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_10' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id\n" ;			 
	
		# DAYS 1-11
		} elsif( $day_setting == 11 ) {
			print "curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date1' | sed '1i\\{\"Broadcastitems\":' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" > mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date2' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date3' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date4' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date5' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date6' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date7' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date8' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date9' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_10' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_11' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id\n" ;			 
	
		# DAYS 1-12
		} elsif( $day_setting == 12 ) {
			print "curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date1' | sed '1i\\{\"Broadcastitems\":' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" > mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date2' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date3' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date4' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date5' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date6' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date7' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date8' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date9' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_10' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_11' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_12' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id\n" ;			 
	
		# DAYS 1-13
		} elsif( $day_setting == 13 ) {
			print "curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date1' | sed '1i\\{\"Broadcastitems\":' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" > mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date2' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date3' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date4' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date5' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date6' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date7' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date8' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date9' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_10' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_11' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_12' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_13' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id\n" ;			 
	
		# DAYS 1-14
		} elsif( $day_setting == 14 ) {
			print "curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date1' | sed '1i\\{\"Broadcastitems\":' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" > mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date2' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date3' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date4' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date5' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date6' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date7' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date8' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date9' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_10' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_11' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_12' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_13' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id && curl --compressed -s 'https://live.tvspielfilm.de/static/broadcast/list/$new_id/$date_14' | sed 's/\\[/,/' | sed ':a;N;\$!ba;s/\\n//g' | sed '\$s/.\$//'  | grep \"$new_id\" >> mani/$new_id\n" ;			 
