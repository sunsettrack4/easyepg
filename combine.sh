...
then
	...
	then
		...
		then
			dialog --backtitle "[M131W] EASYEPG SIMPLE XMLTV GRABBER > XML FILE CREATION > ADD" --title "WARNING" --msgbox "Duplicated Channel IDs exist in combined setup!\nPlease remove the duplicated entries from setup.\n\nList of duplicated Channel IDs:\n\n$(</tmp/chduplicates)" 12 55 2> /tmp/value
		fi
	...
	then
		...
		do
			...
			then
				...
				then
					sed '/{"channels":\[/d;/}/d;s/",//g;s/\]//g;s/"//g' hzn_de_channels.json > /tmp/channels_de
				...
				then
					sed '/{"channels":\[/d;/}/d;s/",//g;s/\]//g;s/"//g' hzn_at_channels.json > /tmp/channels_at
				...
				then
					sed '/{"channels":\[/d;/}/d;s/",//g;s/\]//g;s/"//g' hzn_ch_channels.json > /tmp/channels_ch
				...
				then
					sed '/{"channels":\[/d;/}/d;s/",//g;s/\]//g;s/"//g' hzn_nl_channels.json > /tmp/channels_nl
				...
				then
					sed '/{"channels":\[/d;/}/d;s/",//g;s/\]//g;s/"//g' hzn_pl_channels.json > /tmp/channels_pl
				...
				then
					sed '/{"channels":\[/d;/}/d;s/",//g;s/\]//g;s/"//g' hzn_ie_channels.json > /tmp/channels_ie
				...
				then
					sed '/{"channels":\[/d;/}/d;s/",//g;s/\]//g;s/"//g' hzn_sk_channels.json > /tmp/channels_sk
				...
				then
					sed '/{"channels":\[/d;/}/d;s/",//g;s/\]//g;s/"//g' hzn_cz_channels.json > /tmp/channels_cz
				...
				then
					sed '/{"channels":\[/d;/}/d;s/",//g;s/\]//g;s/"//g' hzn_hu_channels.json > /tmp/channels_hu
				...
				then
					sed '/{"channels":\[/d;/}/d;s/",//g;s/\]//g;s/"//g' hzn_ro_channels.json > /tmp/channels_ro
